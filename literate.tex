...
\begin{tabular}{|l|l|}\hline
\textbf{Literate Command} & \textbf{Description}\\ \hline\hline
\texttt{(*** define-output: output-name ***)} & Define a name for the outputs of the preceeding snippet\\ \hline
\texttt{(*** include-output ***)} & The console output of the preceeding snippet\\ \hline
